package com.github.raka.kafkatest.avro.generic;
...
public class GenericRecordExamples {
    ...
    public static void main(String[] args) {
        ...
        customerBuilder.set("first_name", "Raka");
        customerBuilder.set("last_name", "Alpras");
        ...
        customerBuilderWithDefault.set("age", 29);
